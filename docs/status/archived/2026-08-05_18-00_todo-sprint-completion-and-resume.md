...
**Core work shipped.** Output writer injection (100%) is in CHANGELOG `[Unreleased]` → Added. Section d items (CrawlOptions.Stderr nil-safety, TESTING.md docs) — both addressed in subsequent sessions. Calibration items shipped.
