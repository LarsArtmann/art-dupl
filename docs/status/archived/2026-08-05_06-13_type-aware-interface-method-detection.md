...
**Section a was DEAD CODE** — the interface-method pattern was unreachable for Go files because FuncDecl cannot be a clone root. Discovered and fixed in 2026-08-05_06-46. All items in sections b/c are either done (dead-code fix shipped) or aspirational (cross-package detection → ROADMAP).
