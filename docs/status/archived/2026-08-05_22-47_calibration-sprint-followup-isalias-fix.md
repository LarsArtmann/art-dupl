...
**Core work shipped.** IsAlias field pipeline, diff_report ShowSuppressed, HOW_TO_USE updates, and BDD tests all in CHANGELOG `[Unreleased]`. Section c items (re-calibration, regression dataset) → ROADMAP (requires external project access).
