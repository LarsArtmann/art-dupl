...
**Superseded by 2026-08-05_05-47.** All remaining work (var-declaration support, BDD tests, disabled-pattern test, tagliatelle CI fix) completed in the follow-up session. Items shipped in CHANGELOG `[Unreleased]`. Tagliatelle fix still open → TODO_LIST.
