...
2. **`--semantic` mode is still backwards.** It bakes exact identifier names into hashes, making matching *stricter* than structural. T2 (alpha-normalization) would fix this but depends on T1.
