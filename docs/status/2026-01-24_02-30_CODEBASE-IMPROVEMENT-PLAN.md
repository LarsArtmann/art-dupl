...
**Medium Impact / Medium Effort:** 4. Refactor independent test contexts to use setup pattern 5. Extract common assertion patterns 6. Add context-aware test helpers

**Lower Impact / High Effort:** 7. Introduce interfaces for file operations 8. Add performance benchmarks 9. Enable parallel test execution
