...
**PARTIALLY ADDRESSED.** "Detected vs Actionable" summary shipped (`dbed8cbe`). `--min-tokens` shipped (`fd3b0d38`). Remaining items (strings-builder-opener, functional-option-contract patterns) → TODO_LIST.
