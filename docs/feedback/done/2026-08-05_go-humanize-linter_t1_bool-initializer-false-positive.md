...
**ADDRESSED.** `bool-accumulator-initializer` actionability pattern shipped (CHANGELOG `[Unreleased]` → Added). Handles `:=`, `var`, and package-level forms. The false positive is eliminated.
