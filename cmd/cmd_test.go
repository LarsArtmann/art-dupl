...
func testPrintDupls(
	...
	return printDupls(ctx, mock, fread, ch, config.SortBySize, 15, "art-dupl", false, false, 0, 0)
}
...
func TestPrintDupls(t *testing.T) {
	...
	t.Run("cancelled context returns error", func(t *testing.T) {
		...
		err := printDupls(ctx, mock, testFread, ch, config.SortBySize, 15, "art-dupl", false, false, 0, 0)
		if err == nil {
