...
func setupFilter(cfg *config.Config) (*gogenfilter.Filter, error) {
	...
	if !cfg.IncludeGeneric {
		filterOptions = append(filterOptions, gogenfilter.FilterGeneric)

		verboseFprintf(cfg, "Auto-generated code filtering enabled (generic — any \"Code generated by\" comment)")
	}
