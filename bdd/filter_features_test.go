...
func (u *User) Validate() bool {
	return u.ID > 0 && u.Name != ""
		...
		It("should exclude templ generated code when --exclude-templ is used", func() {
...
func Body() templ.Component {
	return nil
			...
			// templ files should be filtered when --exclude-templ is set
...
func Link() string {
	return ""
			...
			// Run without --exclude-templ (templ files included by default)
			cmd = exec.Command(
				"./art-dupl-filter_features-test",
				setup.TmpDir,
				"--threshold",
			...
			outputStr := string(output)
			// Should include templ files by default
