...
//
// The generated fixture MUST carry the `// Code generated` marker: gogenfilter's
// SQLC detection is content-only (no filename gate), so a models.go without the
// marker is legitimate user code and correctly stays in the analysis.
func assertSQLCFileFiltered(setup *testutil.BDDTestSetup, filename, functionName string) {
	...
	generatedCode := "// Code generated by sqlc. DO NOT EDIT.\npackage db\n" + testutil.DuplicateFuncSource(functionName)
