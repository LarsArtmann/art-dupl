...
func process() {
	for i := 0; i < 10; i++ {
		fmt.Println(i)
			...
			// Create templ generated file with same duplicate code
...
func process() {
	for i := 0; i < 10; i++ {
		fmt.Println(i)
			...
			// Should NOT show templ file (filtered by default)
...
func query() {
	for i := 0; i < 10; i++ {
		fmt.Println(i)
			...
			// Create sqlc generated file with same duplicate code
...
func query() {
	for i := 0; i < 10; i++ {
		fmt.Println(i)
			...
			Expect(outputStr).To(ContainSubstring("regular1.go"))
			Expect(outputStr).To(ContainSubstring("regular2.go"))
			// Should NOT show sqlc file (filtered by default)
