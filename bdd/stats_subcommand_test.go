...
func artDuplTest() string {
	...
	Context("When running stats with filter options", func() {
		DescribeTable("should work with filter flag",
			func(testCode string, filenames []string, flag string) {
				testWithFilterFlag(setup, testCode, filenames, flag)
			},
			Entry("filter-generated", "package main\nfunc filterTest() {}", []string{"filter1.go", "filter2.go"}, "--filter-generated"),
			Entry("include-sqlc", "// Code generated by sqlc. DO NOT EDIT.\npackage db\nfunc SQLCFunc() {}", []string{"sqlc1.go", "sqlc2.go"}, "--include-sqlc"),
		)
	})
