...
var sentinelCounter atomic.Int32 //nolint:gochecknoglobals // unique sentinel node ID counter

// BadNodeType is a node type value that never appears in real parsed nodes.
const BadNodeType int32 = -1

func init() { //nolint:gochecknoinits // initialize sentinel counter to safe negative range
